...
public class CustomLanguagesBasedOnUS extends CommonUtils{
	...
	public void UnitedStatesAndOtherLanguagesTest() throws Exception{
		try {
			TestLogger.testLoggerTCStart("Country Selector Based On United States And OtherLanguages Test Case");
			...
			TestLogger.testLoggerTCEnd("Country Selector Based On United States And OtherLanguages Test Case");
		} catch (Exception e) {
			TestLogger.testLoggerInfo("Country Selector Test Case FAILS" + e);
		}
