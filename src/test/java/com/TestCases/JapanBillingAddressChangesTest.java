...
public class JapanBillingAddressChangesTest extends CommonUtils{
	...
	public void JapanBillingAddressFieldsValidationsTest() throws Exception {
		try {
			...
			CheckoutShippingPageActions.SelectStateDropDownInShippingPageJapan("Kagoshima-ken");
			List<String> stateOptions = CheckoutShippingPageActions.GetDropDownOptionsInShippingPageJapan();
			System.out.println("stateOptionsJP: " + stateOptions);
			takeSnapShot();
			CheckoutShippingPageActions.JapanZipCodeInput("123", "1234");
			...
			takeSnapShot();
			CheckoutShippingPageActions.SelectStateDropDownInShippingPageJapan("Kyoto-fu");
			takeSnapShot();
			CheckoutShippingPageActions.JapanZipCodeInput("Test1234567", "Test098765");
			Integer fieldValueZipCode = CheckoutShippingPageActions.GetJapanZipCodeInputValueSize();
			...
			Assert.assertEquals(stateOptions, JapanStateList);
			Assert.assertEquals(fieldValueZipCode.toString(), "7");
