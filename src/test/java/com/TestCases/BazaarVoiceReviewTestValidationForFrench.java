...
public class BazaarVoiceReviewTestValidationForFrench extends CommonUtils{
	...
	@Test (priority=0)
	public void NonGoogleShoppingUser_BazaarVoiceReviewTestValidationForFrench_FRANCE() throws Exception{
		try {
			TestLogger.testLoggerTCStart("Bazaar Voice Review Test Validation For French_FRANCE - TC Start");
			...
			Assert.assertTrue(pageSrc.contains("//apps.bazaarvoice.com/deployments/pipingrock/main_site/staging/fr_FR/bv.js"));
			Assert.assertEquals(d.format(valForAvgStarRating), rABR);
			Assert.assertEquals(titleChk1, "Notes moyennes des clients");
			Assert.assertEquals(titleChk2, "Générale");
			Assert.assertEquals(titleChk3, "Qualité du produit");
			Assert.assertEquals(titleChk4, "Rapport qualité-prix du produit");
			Assert.assertEquals(titleChk5, "Sélectionnez une ligne ci-dessous pour filtrer les avis.");
			Assert.assertEquals(titleChk6, "Avis");
			Assert.assertEquals(titleChk7, "Description sommaire de la notation");
			TestLogger.testLoggerTCEnd("Bazaar Voice Review Test Validation For French_FRANCE - TC End");
		} catch (Exception e) {
			TestLogger.testLoggerInfo("Bazaar Voice Review Test Validation For French_FRANCE - Failed" + e);
		}
	}
	
	@Test (priority=1)
	public void NonGoogleShoppingUser_BazaarVoiceReviewTestValidationForFrench_CANADA() throws Exception{
		try {
			TestLogger.testLoggerTCStart("Bazaar Voice Review Test Validation For French_CANADA - TC Start");
			...
			System.out.println("Rating Snapshot Title " + titleChk7);
			String pageSrc = driver.getPageSource(); 
			Assert.assertTrue(pageSrc.contains("//apps.bazaarvoice.com/deployments/pipingrock/main_site/staging/fr_CA/bv.js"));
			Assert.assertEquals(d.format(valForAvgStarRating), rABR);
			Assert.assertEquals(titleChk1, "Notes moyennes des clients");
			Assert.assertEquals(titleChk2, "Global");
			Assert.assertEquals(titleChk3, "Qualité du produit");
			Assert.assertEquals(titleChk4, "Rapport qualité-prix du produit");
			Assert.assertEquals(titleChk5, "Sélectionnez une ligne ci-dessous pour filtrer les avis.");
			Assert.assertEquals(titleChk6, "Évaluations");
			Assert.assertEquals(titleChk7, "Sommaire de la notation");
	...
	@Test (priority=2)
	public void NonGoogleShoppingUser_BazaarVoiceReviewTestValidationForFrench_SWITZERLAND() throws Exception{
		try {
			TestLogger.testLoggerTCStart("Bazaar Voice Review Test Validation For French_SWITZERLAND - TC Start");
			HomePageActions.ClickPipingRockLogoHeader();
			CountrySelectorActions.ClickCountrySelectorInHomePage();
			...
			System.out.println("Rating Snapshot Title " + titleChk7);
			String pageSrc = driver.getPageSource(); 
			Assert.assertTrue(pageSrc.contains("//apps.bazaarvoice.com/deployments/pipingrock/main_site/staging/fr_CH/bv.js"));
			Assert.assertEquals(d.format(valForAvgStarRating), rABR);
			Assert.assertEquals(titleChk1, "Notes moyennes des clients");
			Assert.assertEquals(titleChk2, "Générale");
			Assert.assertEquals(titleChk3, "Qualité du produit");
			...
			Assert.assertEquals(titleChk6, "Avis");
			Assert.assertEquals(titleChk7, "Description sommaire de la notation");
			TestLogger.testLoggerTCEnd("Bazaar Voice Review Test Validation For Swedish_SWITZERLAND - TC End");
		} catch (Exception e) {
			TestLogger.testLoggerInfo("Bazaar Voice Review Test Validation For Swedish_SWITZERLAND - Failed" + e);
		}
	}
