...
public class AustraliaShippingAddressChangesTest extends CommonUtils{
	...
	public void AustraliaFieldsValidationsTest() throws Exception {
		try {
			...
			CheckoutShippingPageActions.SelectStateDropDownInShippingPageAustralia("Tasmania");
			List<String> stateOptions2 = CheckoutShippingPageActions.GetDropDownOptionsInShippingPageAustralia();
			System.out.println("stateOptionsAUS: " + stateOptions2);
			takeSnapShot();
			...
			if (PageCheck == "https://staging-in.testpipingrock.com/checkout/shipping/choose") {
