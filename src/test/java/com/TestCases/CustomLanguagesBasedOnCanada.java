...
public class CustomLanguagesBasedOnCanada extends CommonUtils{
	...
	public void CanadaAndOtherLanguagesTest() throws Exception{
		try {
			TestLogger.testLoggerTCStart("Country Selector Based On Canada And OtherLanguages Test Case");
			...
			TestLogger.testLoggerTCEnd("Country Selector Based On Canada And OtherLanguages Test Case");
		} catch (Exception e) {
			TestLogger.testLoggerInfo("Country Selector Based On Canada Test Case FAILS" + e);
		}
