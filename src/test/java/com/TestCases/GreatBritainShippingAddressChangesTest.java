...
public class GreatBritainShippingAddressChangesTest extends CommonUtils{
	...
	@Test (priority=2)
	public void GreatBritainShippingAddressFieldsValidationsTest() throws Exception {
		try {
			...
			if (PageCheck == "https://demo-in.testpipingrock.com/checkout/shipping/choose") {
				...
				Assert.assertEquals(fieldValuePhoneNum.toString(), "30");
				takeSnapShot();
			}
