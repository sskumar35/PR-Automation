...
public class KoreaShippingAddressChangesTest extends CommonUtils{
	...
	@Test (priority=2)
	public void KoreaFieldsValidationsTest() throws Exception {
		try {
			...
			takeSnapShot();
			CheckoutShippingPageActions.ZipCodeInputFieldInShippingPage("12345");
			...
			if (PageCheck == "https://demo-in.testpipingrock.com/checkout/shipping/choose") {
				...
				Assert.assertEquals(fieldValueZipCode.toString(), "5");
