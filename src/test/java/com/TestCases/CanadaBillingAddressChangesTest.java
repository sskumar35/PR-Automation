...
public class CanadaBillingAddressChangesTest extends CommonUtils{
	...
	@Test (priority=2)
	public void CanadaBillingAddressFieldsValidationsTest() throws Exception {
		try {
			...
			CheckoutShippingPageActions.SelectStateDropDownInShippingPageCanada("Ontario");
			...
			takeSnapShot();
			CheckoutShippingPageActions.ZipCodeInputFieldInShippingPage("A2A2A2A2A2A2A2");
