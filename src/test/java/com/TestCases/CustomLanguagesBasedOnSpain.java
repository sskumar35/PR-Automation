...
public class CustomLanguagesBasedOnSpain extends CommonUtils{
	...
	public void SpainAndOtherLanguagesTest() throws Exception{
		try {
			TestLogger.testLoggerTCStart("Country Selector Based On Spain And OtherLanguages Test Case");
			...
			TestLogger.testLoggerTCEnd("Country Selector Based On Spain And OtherLanguages Test Case");
		} catch (Exception e) {
			TestLogger.testLoggerInfo("Country Selector Based On Spain Test Case FAILS" + e);
		}
