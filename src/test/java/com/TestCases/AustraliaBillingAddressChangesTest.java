...
public class AustraliaBillingAddressChangesTest extends CommonUtils{
	...
	@Test (priority=2)
	public void AustraliaBillingAddressFieldsValidationsTest() throws Exception {
		try {
			List<String> AusStateList = new ArrayList<String>(Arrays.asList("", "Australian Capital Territory", "New South Wales", "Northern Territory", "Queensland", "South Australia", "Tasmania", "Victoria", "Western Australia"));
			...
			CheckoutShippingPageActions.SelectStateDropDownInShippingPageAustralia("New South Wales");
			...
			CheckoutShippingPageActions.SelectStateDropDownInShippingPageAustralia("Western Australia");
			takeSnapShot();
			...
			Assert.assertEquals(stateOptions, AusStateList);
			Assert.assertEquals(fieldValueZipCode.toString(), "4");
