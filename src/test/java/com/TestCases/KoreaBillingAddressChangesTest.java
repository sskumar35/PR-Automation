...
public class KoreaBillingAddressChangesTest extends CommonUtils{
	...
	@Test (priority=2)
	public void KoreaBillingAddressFieldsValidationsTest() throws Exception {
		try {
			...
			//Assert.assertEquals(fieldValueState.toString(), "30");
