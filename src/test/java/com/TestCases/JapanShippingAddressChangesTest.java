...
public class JapanShippingAddressChangesTest extends CommonUtils{
	...
	@Test (priority=2)
	public void JapanFieldsValidationsTest() throws Exception {
		try {
			...
			CheckoutShippingPageActions.SelectStateDropDownInShippingPageJapan("Fukushima-ken");
			...
			CheckoutShippingPageActions.SelectStateDropDownInShippingPageJapan("Hiroshima-Ken");
			takeSnapShot();
