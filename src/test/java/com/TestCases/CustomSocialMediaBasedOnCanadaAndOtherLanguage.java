...
public class CustomSocialMediaBasedOnCanadaAndOtherLanguage extends CommonUtils{
	...
	@Test(priority=0)
	public void CanadaAndOtherLanguagesTest() throws Exception{
		try {
			TestLogger.testLoggerTCStart("Custom Social Media Based On Canada And OtherLanguages Test Case");
			...
			String HeaderForCA = CountrySelectorActions.GetCountrySelectorPageHeader();
			Assert.assertTrue(HeaderForCA.contains("We proudly ship to over 160 countries!"));
			takeSnapShot();
			...
			TestLogger.testLoggerTCEnd("Custom Social Media Based On Canada And OtherLanguages Test Case");
		} catch (Exception e) {
